...
# Ravdess_df.to_csv('ravdess_path_emotion.csv')
...
# Crema_df.to_csv('cremad_path_emotion.csv')
...
# Tess_df.to_csv('tess_path_emotion.csv')
...
# Savee_df.to_csv('savee_path_emotion.csv')
...
# Shemo_df.to_csv('shemo_path_emotion.csv')
